...
/**
 * Step output / env var naming the base commit that {@link BASE_WORKFLOW_RUN_ID_OUTPUT}'s run is
 * building.
 *
 * Steps and jobs resolve the base independently and can land on different commits, so a run id
 ...
 */
export const BASE_COMMIT_SHA_OUTPUT = "base-commit-sha";
